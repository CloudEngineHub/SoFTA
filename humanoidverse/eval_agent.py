...
def main(override_config: OmegaConf):
    ...
    import torch
    from humanoidverse.utils.inference_helpers import export_multi_agent_wbc_policy_as_onnx
    ...
    if EXPORT_ONNX:
        ...
        export_multi_agent_wbc_policy_as_onnx(algo.inference_model, exported_policy_path, exported_onnx_name, example_obs_dict)
